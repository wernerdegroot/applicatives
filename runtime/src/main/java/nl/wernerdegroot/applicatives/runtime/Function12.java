...
public interface Function12<A, B, C, D, E, F, G, H, I, J, K, L, Result> {
    ...
    default Result apply(Tuple11<? extends A, ? extends B, ? extends C, ? extends D, ? extends E, ? extends F, ? extends G, ? extends H, ? extends I, ? extends J, ? extends K> tuple, L twelfth) {

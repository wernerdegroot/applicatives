...
public interface Function15<A, B, C, D, E, F, G, H, I, J, K, L, M, N, O, Result> {
    ...
    default Result apply(Tuple14<? extends A, ? extends B, ? extends C, ? extends D, ? extends E, ? extends F, ? extends G, ? extends H, ? extends I, ? extends J, ? extends K, ? extends L, ? extends M, ? extends N> tuple, O fifteenth) {

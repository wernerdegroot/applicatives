...
public interface UnaryOperatorsOverloads {
    ...
    default <P1, P2, R extends nl.wernerdegroot.applicatives.runtime.decompositions.Decomposable2<P1, P2>> java.util.function.BiFunction<java.util.function.UnaryOperator<P1>, java.util.function.UnaryOperator<P2>, java.util.function.UnaryOperator<R>> lift(java.util.function.BiFunction<? super P1, ? super P2, ? extends R> fn) {
        return (first, second) ->
    ...
    default <P1, P2, P3, R extends nl.wernerdegroot.applicatives.runtime.decompositions.Decomposable3<P1, P2, P3>> nl.wernerdegroot.applicatives.runtime.Function3<java.util.function.UnaryOperator<P1>, java.util.function.UnaryOperator<P2>, java.util.function.UnaryOperator<P3>, java.util.function.UnaryOperator<R>> lift(nl.wernerdegroot.applicatives.runtime.Function3<? super P1, ? super P2, ? super P3, ? extends R> fn) {
        return (first, second, third) ->
    ...
    default <P1, P2, P3, P4, R extends nl.wernerdegroot.applicatives.runtime.decompositions.Decomposable4<P1, P2, P3, P4>> nl.wernerdegroot.applicatives.runtime.Function4<java.util.function.UnaryOperator<P1>, java.util.function.UnaryOperator<P2>, java.util.function.UnaryOperator<P3>, java.util.function.UnaryOperator<P4>, java.util.function.UnaryOperator<R>> lift(nl.wernerdegroot.applicatives.runtime.Function4<? super P1, ? super P2, ? super P3, ? super P4, ? extends R> fn) {
        return (first, second, third, fourth) ->

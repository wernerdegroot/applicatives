...
public interface ParametersOverloads<R> {
    ...
    default <P1, P2, P3, R> java.util.function.Function<R, java.lang.StringBuilder> combine(java.util.function.Function<? super P1, ? extends java.lang.String> first, java.util.function.Function<? super P2, ? extends java.lang.String> second, java.util.function.Function<? super P3, ? extends java.lang.String> third, nl.wernerdegroot.applicatives.runtime.decompositions.Decomposition3<? super R, ? extends P1, ? extends P2, ? extends P3> decomposition) {
        return this.combineImpl(nl.wernerdegroot.applicatives.ParametersOverloads.Tuples.<P1, P2, R>tuple(this, first, second), third, decomposition::decompose, nl.wernerdegroot.applicatives.runtime.Tuple3::withoutThird, nl.wernerdegroot.applicatives.runtime.Tuple3::getThird);
    }
    ...
    default <P1, P2, P3, P4, R> java.util.function.Function<R, java.lang.StringBuilder> combine(java.util.function.Function<? super P1, ? extends java.lang.String> first, java.util.function.Function<? super P2, ? extends java.lang.String> second, java.util.function.Function<? super P3, ? extends java.lang.String> third, java.util.function.Function<? super P4, ? extends java.lang.String> fourth, nl.wernerdegroot.applicatives.runtime.decompositions.Decomposition4<? super R, ? extends P1, ? extends P2, ? extends P3, ? extends P4> decomposition) {
        return this.combineImpl(nl.wernerdegroot.applicatives.ParametersOverloads.Tuples.<P1, P2, P3, R>tuple(this, first, second, third), fourth, decomposition::decompose, nl.wernerdegroot.applicatives.runtime.Tuple4::withoutFourth, nl.wernerdegroot.applicatives.runtime.Tuple4::getFourth);
    }
    ...
    class Tuples {
        ...
        public static <P1, P2, R> java.util.function.Function<nl.wernerdegroot.applicatives.runtime.Tuple2<? extends P1, ? extends P2>, java.lang.StringBuilder> tuple(nl.wernerdegroot.applicatives.ParametersOverloads<R> self, java.util.function.Function<? super P1, ? extends java.lang.String> first, java.util.function.Function<? super P2, ? extends java.lang.String> second) {
        ...
        public static <P1, P2, P3, R> java.util.function.Function<nl.wernerdegroot.applicatives.runtime.Tuple3<? extends P1, ? extends P2, ? extends P3>, java.lang.StringBuilder> tuple(nl.wernerdegroot.applicatives.ParametersOverloads<R> self, java.util.function.Function<? super P1, ? extends java.lang.String> first, java.util.function.Function<? super P2, ? extends java.lang.String> second, java.util.function.Function<? super P3, ? extends java.lang.String> third) {
            return self.combineImpl(nl.wernerdegroot.applicatives.ParametersOverloads.Tuples.<P1, P2, R>tuple(self, first, second), third, java.util.function.Function.identity(), nl.wernerdegroot.applicatives.runtime.Tuple3::withoutThird, nl.wernerdegroot.applicatives.runtime.Tuple3::getThird);
        }
